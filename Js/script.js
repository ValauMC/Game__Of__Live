...
function updateBoard() {
    ...
    let changes = []; //Almacenar los cambios para aplicarlos después de calcular todos los estados
    ...
    for (let i = 0; i < rows; i++) {
        for (let j = 0; j < cols; j++){
            ...
            if (isLive && (liveCount < 2 || liveCount > 3)) { // 1. Regla
                ...
                // Si esta muerta y tiene tres vecinas vivas. Nace una nueva célula
